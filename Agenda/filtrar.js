...
btn_gravar.addEventListener("click", (evt) => {
    ...
    .then(res=>{
        if(res.status==200){
            ...
            preencherdgv("http://127.0.0.1:1880/pesquisartodasagenda");
        }else{
...
const preencherdgv = (endpoint) => {
    dados.innerHTML = "";
    const endpointtodoscontato = `http://127.0.0.1:1880/pesquisartodasagenda`;
    fetch(endpointtodoscontato)
        .then(res => res.json())
        .then(res => {
...
btn_filtro.addEventListener("click",(evt)=>{
